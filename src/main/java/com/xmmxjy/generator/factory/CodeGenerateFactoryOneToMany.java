...
import com.xmmxjy.generator.pojo.onetomany.CodeParamEntity;
import com.xmmxjy.generator.pojo.onetomany.SubTableEntity;
...
public class CodeGenerateFactoryOneToMany {
    ...
    public static void oneToManyCreate(CodeParamEntity codeParamEntityIn, List<SubTableEntity> subTabParamIn) {
        try {
            ...
            SimpleDateFormat e1 = new SimpleDateFormat("yyyy年MM月dd日 HH时mm分ss秒 E ");
            String nowDate = e1.format(new Date());
