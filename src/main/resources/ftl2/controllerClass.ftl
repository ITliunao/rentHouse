package com.xmm.${controllerPackage}.controller;
...
* @return
*/
@RequiresPermissions("${lowerName}.list")
...
List<${className}Entity> list = ${lowerName}Service.select(${lowerName});
    ...
    * @return
    */
    @RequiresPermissions("${lowerName}.add")
    ...
    * @return
    */
    @RequiresPermissions("${lowerName}.edit")
    ...
    * @return
    */
    @RequiresPermissions("${lowerName}.detail")
    ...
    */
    ...
    @RequiresPermissions("${lowerName}.delete")
