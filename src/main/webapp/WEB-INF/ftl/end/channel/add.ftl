    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="dailogForm" action="${basePath}/channel/doAdd.do" method="POST">
                    <input type="hidden" id="btn_sub" class="btn_sub" />
                    <div class="form-group mno">
                        <label for="parentId" class="col-sm-2 control-label" style="text-align:left;">父栏目ID</label>
                        <div class="col-sm-8">
                            <input type="hidden" name="parentId" id="pId" class="form-control" />
                    ...
                    <div class="form-group mno">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="sort" id="sort" class="form-control"  datatype="*" />
                        </div>
                    </div>
                    <div class="form-group mno">
                        <label for="isDisplay" class="col-sm-2 control-label" style="text-align:left;">是否显示</label>
                        <div class="col-sm-8">
                            <input type="text" name="isDisplay" id="isDisplay" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group mno">
