	...
	<div class="row">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" id="dailogForm" action="${basePath}/user/doEdit.do" method="POST">
					<input type="hidden" id="btn_sub" class="btn_sub" />
					<input type="hidden" value="${user.id}" name="id"/>
					<div class="form-group mno">
						<label for="username" class="col-sm-2 control-label" style="text-align:left;">用户名</label>
						<div class="col-sm-8">
							<input type="text" name="username" id="username" value="${user.username}" class="form-control"  datatype="*" />
						</div>
					</div>
					<div class="form-group mno">
						<label for="realName" class="col-sm-2 control-label" style="text-align:left;">真实姓名</label>
						<div class="col-sm-8">
							<input type="text" name="realName" value="${user.realName}"  id="realName" class="form-control" />
						</div>
					</div>
					<div class="form-group mno">
					...
					<div class="form-group mno">
						...
						<div class="col-sm-8">
							<input type="text"  name="sex" id="sex" value="${user.sex!}" class="form-control" />
						</div>
					</div>
					<div class="form-group mno">
						<label for="mobilePhone" class="col-sm-2 control-label" style="text-align:left;">手机号码</label>
						<div class="col-sm-8">
							<input type="text" name="mobilePhone" id="mobilePhone" value="${user.mobilePhone!}" class="form-control" />
						</div>
					</div>
					<div class="form-group mno">
						<label for="officePhone" class="col-sm-2 control-label" style="text-align:left;">办公室电话</label>
						<div class="col-sm-8">
							<input type="text" name="officePhone" id="officePhone" value="${user.officePhone}" class="form-control" />
						</div>
					</div>
					<div class="form-group mno">
					...
					<div class="form-group mno">
						...
						<div class="col-sm-8">
							<input type="text" name="lastLoginTime" id="lastLoginTime" value="${user.lastLoginTime}" class="form-control" />
						</div>
					</div>
					<div class="form-group mno">
						<label for="lastLoginIp" class="col-sm-2 control-label" style="text-align:left;">上次登录IP</label>
						<div class="col-sm-8">
							<input type="text" name="lastLoginIp" id="lastLoginIp" value="${user.lastLoginIp}" class="form-control" />
						</div>
					</div>
					...
					<div class="form-group mno">
						...
						<div class="col-sm-8">
							<input type="text" name="departId" id="departId" value="${user.departId}" class="form-control" />
						</div>
					</div>
					<div class="form-group mno">
