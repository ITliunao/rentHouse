            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="dailogForm" action="${basePath}/role/doEdit.do" method="POST">
                    ...
                    <div class="form-group mno">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" value="${role.roleCode!}" name="roleCode" id="roleCode" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="roleName" class="col-sm-2 control-label" style="text-align:left;">角色名称</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${role.roleName!}" name="roleName" id="roleName" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="updateName" class="col-sm-2 control-label" style="text-align:left;">修改人</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${role.updateName!}" name="updateName" id="updateName" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="updateDate" class="col-sm-2 control-label" style="text-align:left;">修改时间</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${role.updateDate!}" name="updateDate" id="updateDate" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="updateBy" class="col-sm-2 control-label" style="text-align:left;">修改人id</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${role.updateBy!}" name="updateBy" id="updateBy" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="createName" class="col-sm-2 control-label" style="text-align:left;">创建人</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${role.createName!}" name="createName" id="createName" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="createDate" class="col-sm-2 control-label" style="text-align:left;">创建时间</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${role.createDate!}" name="createDate" id="createDate" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="createBy" class="col-sm-2 control-label" style="text-align:left;">创建人id</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${role.createBy!}" name="createBy" id="createBy" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
