<div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                <form role="search" class="navbar-form-custom" method="post" action="search_results.html" style="width: 250px;">
                    <div class="form-group">
                        <input type="text" placeholder="java后台管理系统" class="form-control" name="top-search" id="top-search">
                    </div>
                </form>
            </div>
        </nav>
    ...
    <div class="row content-tabs">
        ...
        <nav class="page-tabs J_menuTabs">
            <div class="page-tabs-content">
                <a href="javascript:;" class="active J_menuTab" data-id="${basePath}/home.do">首页</a>
            </div>
    ...
    <div class="footer">
        <div class="pull-right">© <a href="http://www.xmmxjy.com/" target="_blank">xmmxjy</a>
        </div>
    </div>
</div>
