            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="dailogForm" action="${basePath}/contentAttribute/doEdit.do" method="POST">
                    ...
                    <div class="form-group mno">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" value="${contentAttribute.source!}" name="source" id="source" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="sourceUrl" class="col-sm-2 control-label" style="text-align:left;">来源地址</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${contentAttribute.sourceUrl!}" name="sourceUrl" id="sourceUrl" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="data" class="col-sm-2 control-label" style="text-align:left;">数据JSON</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${contentAttribute.data!}" name="data" id="data" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="text" class="col-sm-2 control-label" style="text-align:left;">内容</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${contentAttribute.text!}" name="text" id="text" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
                                <label for="wordCount" class="col-sm-2 control-label" style="text-align:left;">字数</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${contentAttribute.wordCount!}" name="wordCount" id="wordCount" class="form-control"/>
                                </div>
                            </div>
                    <div class="form-group mno">
